...
/* General user-level programmer's API: X server (root) only  */
    ...
    pub fn drmUpdateDrawableInfo(fd: c_int, handle: drm_drawable_t, drawable_info_type: drm_drawable_info_type_t, num: c_uint, data: *mut c_void) -> c_int;
...
/* Skip list routines */
    ...
    pub fn drmSLLookupNeighbors(l: *mut c_void, key: c_ulong, prev_key: *mut c_ulong, prev_value: *mut *mut c_void, next_key: *mut c_ulong, next_value: *mut *mut c_void) -> c_int;
    pub fn drmOpenOnce(unused: *mut c_void, BusID: *const c_char, newlyopened: *mut c_int) -> c_int;
    pub fn drmOpenOnceWithType(BusID: *const c_char, newlyopened: *mut c_int, open_type: c_int) -> c_int;
    ...
    pub fn drmPrimeHandleToFD(fd: c_int, handle: uint32_t, flags: uint32_t, prime_fd: *mut c_int) -> c_int;
